    ...
    components: {
        ...
        message: {
            ...
            responseViewer: {
                ...
                tokenRate: string;
                flags: string;
                functionResponseMessage: string;
                summaryMessage: string;
                model: string;
                legacyTotalTokens: string;
                latency: string;
                firstChunkTime: string;
                promptTokenDetails: string;
                outputTokenDetails: string;
                yes: string;
                no: string;
                name: string;
                mimeType: string;
                ...
                copySuccess: string;
                copyFailed: string;
                pairedFunctionResponse: string;
                responseSource: string;
                sourceMessage: string;
                responseSources: {
                    tool: string;
                    partFunctionResponse: string;
                    hiddenFunctionResponse: string;
                };
